    ...
    <div className="flex flex-wrap justify-center">
      ...
      <div className="w-full max-w-sm mx-4 my-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
        ...
        <div className="p-6">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-300">Wednesday (Oct. 23) evening in New Orleans, a white SUV tentatively peeks around the corner of Chartres Street in the French Quarter. Though Taylor Swift’s “Fearless” </p>
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="flex flex-wrap justify-center">
      ...
      <div className="w-full max-w-md mx-4 my-4 bg-gray-100 dark:bg-gray-900 rounded-lg shadow-lg p-6">
        <p className="text-lg text-gray-700 dark:text-gray-300">"This company provided excellent service and support. Highly recommend!"</p>
        <div className="mt-4">
      ...
      {/* Review 2 */}
      <div className="w-full max-w-md mx-4 my-4 bg-gray-100 dark:bg-gray-900 rounded-lg shadow-lg p-6">
        <p className="text-lg text-gray-700 dark:text-gray-300">"A wonderful experience from start to finish. Their team is top-notch."</p>
        <div className="mt-4">
      ...
      {/* Review 3 */}
      <div className="w-full max-w-md mx-4 my-4 bg-gray-100 dark:bg-gray-900 rounded-lg shadow-lg p-6">
        <p className="text-lg text-gray-700 dark:text-gray-300">"Their attention to detail and customer service is unparalleled."</p>
        <div className="mt-4">
